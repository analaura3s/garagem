...
class Veiculo(models.Model):
    ano = models.CharField(max_length=4, blank=True, null=True, default=0)
    preco = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True, default=0.00)
